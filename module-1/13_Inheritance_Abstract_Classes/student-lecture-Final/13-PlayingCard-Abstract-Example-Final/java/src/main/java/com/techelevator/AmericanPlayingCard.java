...
public class AmericanPlayingCard extends PlayingCard{
	...
	// a subclass may override a super class if it wants to change the behavior of the super class method
	
	@Override // asks the compiler to verify that the method that follows is a valid Override
	          // a overriding method must have the same name and parameters must have the same type and same order
