# Classes and Encapsulation Exercises
...
- An X in the set column indicates the property must have a *setter* method..
- a derived attribute is one returned from a method rather than stored as a member variable.
- derived attributes method names typically start with `get`
...
**Notes**
 ...
 - this derived attribute should be called `getLetterGrade()`
