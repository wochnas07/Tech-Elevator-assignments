...
public class IntroToClassesCard {
	...
	//
	// main() is always static because there can be only one for an application
	//*****************************************************************************
	...
	public static void main(String[] args) {
        ...
        */
		...
		// Does a PlayingCard equal another PlayingCard with the same values?
		if (card4.equals(card5)) {   // cannot use == to see if reference variables are equal - locations are compared not content
                                     //               use .equals to compare the contnetof reference variables
