...
namespace HTTP_Web_Services_GET_lecture
{
    class Program
    {
        ...
        private static Hotel GetDetailsForHotel(int hotelId)
        {
        ...
        private static List<Review> GetReviewsForHotel(int hotelId)
        {
        ...
        private static List<Hotel> GetHotelsWithStarRating(int starRating)
        {
        ...
        private static City GetPublicAPIQuery()
        {
