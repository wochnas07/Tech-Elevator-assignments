drop sequence if exists seq_employee_id  cascade;
drop table    if exists employee         cascade;
drop sequence if exists seq_department_id cascade;
drop table    if exists department       cascade;
drop sequence if exists seq_project_id   cascade;
...
CREATE SEQUENCE seq_department_id;   -- Create sequence object to generate unique department ids instead of having postgres do it
...
CREATE SEQUENCE seq_project_id;   -- Create sequence object to generate unique project ids instead of having postgres do it
