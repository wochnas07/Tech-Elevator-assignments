...
public class MemoryReservationDAO implements ReservationDAO {
    ...
    public MemoryReservationDAO(HotelDAO hotelDAO) {   // ctor receives a HotelDAO object as a parameter
        this.hotelDAO = hotelDAO;                      // Assign the HotelDAO object it receives to the HotelDAO reference
