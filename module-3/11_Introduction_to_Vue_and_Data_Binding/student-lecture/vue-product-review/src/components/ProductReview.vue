<template>      <!-- Our html goes here         -->
    <div class = 'main'>    <!-- Place our code in the main part of the page -->
        <h2> Product Reviews for {{ title }} </h2> <!-- Use a mustache {{}} to indicate you want data from the component placed here -->
...
export default{ // Expose data from this code to external processes (like Vue)
    name: 'product-review', // name for the default export is the component name in kabob-case
                            //      kabob-case - all lowercase with '-' between the words
...
<style scoped>  /* Our CSS code goes here       */
div.main {
  margin: 1rem 0;
}
